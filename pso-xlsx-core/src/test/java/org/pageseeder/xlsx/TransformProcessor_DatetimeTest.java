...
public class TransformProcessor_DatetimeTest {
  private static final String DEFAULT_OUTPUT_ROOT_FOLDER = "/build/output/core/datetime";
  ...
  public void testInterim_SplitWorkbook_RichtextTrue(){
    genericTestInterim_SplitWorkbook_Richtext(true);
  }

  @Test
  public void testInterim_SplitWorkbook_RichtextFalse(){
    genericTestInterim_SplitWorkbook_Richtext(false);
  }

  public void genericTestInterim_SplitWorkbook_Richtext(boolean richText){
    File input = new File("src/test/resources/org/pageseeder/xlsx/core/datetime/datetime-sample.xlsx");
    System.out.println(input.getAbsolutePath());
    File outputFolder = new File( DEFAULT_OUTPUT_ROOT_FOLDER + "/richtext-" + richText + "/interim-workbook");
    ...
    try {
      ...
      //hh:mm:ss AM/PM
      assertThat(interimXML).valueByXPath("/workbook/worksheet/row[@position='24']/col[@ref='A']/text()").isEqualTo("hh:mm:ss AM/PM");
      assertThat(interimXML).valueByXPath("/workbook/worksheet/row[@position='24']/col[@ref='B']/text()").isEqualTo("00:59:59");
    } catch (IOException e) {
